...
String query="select * from participant where username='" + session.getAttribute("userid") +"'";
...
%>
<p>Get notifications to: <%=rs.getString("email")%></p>
 <h1><strong><a href="participanthome.jsp">Confrm</a></strong></h1> 
<%
} rs.close();
    stmt.close();
    conn.close();
