...
<h1><strong>Questions from Participants</strong></h1>
<%
try
{
...
String query="select * from connectstaff";
...
%></table><p>Question</p></br>
    <tr>
    
    <td>Name___:<input type="text" value="<%=rs.getString("name") %>"><br></td>
    <td>Email____:<input type="text" value="<%=rs.getString("email") %>"><br></td>
    <td>Suject___:<input type="text" value="<%=rs.getString("subject") %>"><br></td>
    <td>Question:<input type="text" value="<%=rs.getString("question") %>"><br></td>
